...
//! collection. Named after the shape rather than after one of its three callers: the copy
//! that tells them apart is theirs (`view::addhost`, `view::collections`), and the logic is
//! `app::state::{addhost,edithost,collections}`.
use crate::ui;
